...
interface MapApiKeyModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfigChanged?: (config: MapConfig) => void;
}
...
export const MapApiKeyModal: React.FC<MapApiKeyModalProps> = ({
  ...
  const [config, setConfig] = useState<MapConfig>(getMapConfig());
  ...
  const handleSelectProvider = (prov: MapTileProvider) => {
    ...
    <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-fade-in font-mono">
      <div className="relative w-full max-w-2xl bg-command-panel border border-command-border rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="p-6 overflow-y-auto space-y-6 text-xs text-slate-300">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5">
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="font-bold text-slate-100">CartoDB Dark</span>
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="font-bold text-slate-100">Mapbox Optical</span>
          ...
          <div className="p-4 rounded-xl bg-command-bg border border-command-border space-y-3">
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-4 pt-1 text-[11px]">
                ...
                <label className="flex items-center gap-1.5 cursor-pointer text-slate-300">
                  <input
                    ...
                    className="accent-cyan-400"
                  />
                  <span>Mapbox Dark Tactical Vector</span>
                </label>
              </div>
            )}
          </div>
              ...
              <div className="flex gap-4 pt-1 text-[11px]">
                <label className="flex items-center gap-1.5 cursor-pointer text-slate-300">
                  <input
                    ...
                    className="accent-cyan-400"
                  />
                  <span>Google Hybrid Satellite</span>
                </label>
                <label className="flex items-center gap-1.5 cursor-pointer text-slate-300">
                  <input
                    type="radio"
                    ...
                    className="accent-cyan-400"
                  />
                  <span>Google Standard Road Network</span>
                </label>
              </div>
            )}
          </div>
        ...
        <div className="p-4 border-t border-command-border bg-command-bg/90 flex items-center justify-between">
          ...
          >
            ...
            <span>Reset to Free Default (CartoDB)</span>
          </button>
