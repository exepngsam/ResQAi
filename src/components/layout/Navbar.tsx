...
import { ShieldAlert, Radio, Activity, Clock, AlertTriangle } from 'lucide-react';
  ...
  return (
    <header className="h-16 bg-command-panel border-b border-command-border px-4 md:px-6 flex items-center justify-between select-none z-40 sticky top-0">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <div className="flex items-center gap-2">
            <span className="font-extrabold tracking-wider text-base text-white">DISASTER<span className="text-red-500">IQ</span></span>
      ...
      <div className="flex items-center gap-4 text-xs font-mono">
        ...
        {/* Digital Time */}
        <div className="hidden sm:flex items-center gap-1.5 text-slate-300 bg-command-bg border border-command-border px-2.5 py-1 rounded">
